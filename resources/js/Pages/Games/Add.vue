        ...
        <div class="w-full p-3 mt-1 ml-[0.30rem] border rounded overflow-hidden shadow-lg">
            ...
            <div class="w-full border rounded overflow-hidden shadow-sm flex">
                <div class="m-2 w-60">
                    ...
                    <select v-model="selectedPartner" id="partner" class="block p-2 mb-6 w-full text-sm text-black bg-gray-50 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-white  dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="m-2 w-60">
                    ...
                    <select id="provider" class="block p-2 mb-6 w-full text-sm text-black bg-gray-50 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-white  dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
